var _analytics = (function (exports) {
  ...
  function s(r) {
    return function (e) {
      for (var r, n = {}, o = /([^&=]+)=?([^&]*)/g; r = o.exec(e);) {
        var a = t(r[1]),
            i = t(r[2]);
        "[]" === a.substring(a.length - 2) ? (n[a = a.substring(0, a.length - 2)] || (n[a] = [])).push(i) : n[a] = "" === i || i;
      }

      for (var u in n) {
        var c = u.split("[");
        c.length > 1 && (m(n, c.map(function (e) {
          return e.replace(/[?[\]\\ ]/g, "");
        }), n[u]), delete n[u]);
      }
  ...
  function m(e, r, n) {
    for (var t = r.length - 1, o = 0; o < t; ++o) {
      var a = r[o];
      a in e || (e[a] = {}), e = e[a];
    }
  ...
  function y() {
    for (var e = "", r = 0, n = 4294967295 * Math.random() | 0; r++ < 36;) {
      var t = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx"[r - 1],
          o = 15 & n;
      e += "-" == t || "4" == t ? t : ("x" == t ? o : 3 & o | 8).toString(16), n = r % 8 == 0 ? 4294967295 * Math.random() | 0 : n >> 4;
    }

    return e;
  }

  var l$1 = "object" == typeof self && self.self === self && self || "object" == typeof global && global.global === global && global || void 0,
      e = "undefined";
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
                      ...
                      switch (_context3.prev = _context3.next) {
                        ...
                        case 3:
                          ...
                          return data.namespaced[pluginName].reduce( /*#__PURE__*/function () {
                            var _ref7 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(acc, p$1, count) {
            ...
            case 10:
              ...
              _context5.next = 13;
              return data.exact.reduce( /*#__PURE__*/function () {
                var _ref8 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(promise, curr, i) {
  ...
  */
  ...
  function analytics() {
    ...
    var instance = {
      ...
      */
      identify: function () {
        var _identify = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(userId, traits, options, callback) {
       ...
       */
      track: function () {
        var _track = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(eventName, payload, options, callback) {
          var name, data, opts;
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
       ...
       */
      page: function () {
        var _page = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(data, options, callback) {
          var d, opts;
          return regenerator.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
    ...
    if (c && config.debug) {
      ...
      composeWithGlobalDebug = function composeWithGlobalDebug() {
        ...
        if (g(_typeof_1(arguments[0]))) return composeWithDebug();
  ...
  function a$1() {
    ...
    try {
      p$1(e, "1"), i = -1 !== document.cookie.indexOf(e), u(e);
    } catch (e) {
      i = !1;
    }
  ...
  function l$2() {
    if (typeof a$2 !== e) return a$2;
    a$2 = !0;

    try {
      typeof localStorage !== e && typeof JSON !== e || (a$2 = !1), localStorage.setItem(e, e), localStorage.removeItem(e);
    } catch (t) {
      a$2 = !1;
    }
  ...
  function s$1(o) {
    ...
    try {
      if ("true" === (t = JSON.parse(o))) return !0;
      if ("false" === t) return !1;
      if (g(t)) return t;
  ...
  function b$1(t, r$1) {
    if (t) {
      var a = C(r$1),
          l$1 = !F(a),
          i = d$1(a) ? s$1(localStorage.getItem(t)) : void 0;
      if (l$1 && !l(i)) return i;
      var c = h(a) ? s$1(r(t)) : void 0;
      if (l$1 && c) return c;
      var n = o(t);
      return l$1 ? n : {
        localStorage: i,
  ...
  function I(r$1, a, i) {
    if (r$1 && !l(a)) {
      var c = {},
          ...
          g = JSON.stringify(a),
          f$1 = !F(n);
      return d$1(n) && (c.localStorage = {
        location: "localStorage",
        current: a,
        previous: s$1(localStorage.getItem(r$1))
      }, localStorage.setItem(r$1, g), f$1) ? c.localStorage : h(n) && (c.cookie = {
        location: "cookie",
        current: a,
        previous: s$1(r(r$1))
      }, c$1(r$1, g), f$1) ? c.cookie : (c.global = {
        location: "global",
        current: a,
        previous: o(r$1)
      }, f(r$1, a), f$1 ? c.global : c);
    }
  }
  ...
  function x(o, t) {
    if (o) {
      var a = C(t),
          e = b$1(o, "*"),
          l$1 = {};
      return !l(e.localStorage) && d$1(a) && (localStorage.removeItem(o), l$1.localStorage = e.localStorage), !l(e.cookie) && h(a) && (u(o), l$1.cookie = e.cookie), !l(e.global) && J(a, "global") && (n(o), l$1.global = e.global), l$1;
    }
  }

  function C(o) {
    return o ? a(o) ? o : o.storage : "any";
  }

  function d$1(o) {
    return p$2 && J(o, "localStorage");
  }

  function h(o) {
    return y$1 && J(o, "cookie");
  }
